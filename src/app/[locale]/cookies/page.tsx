...
export async function generateMetadata({ params }: { params: Promise<{ locale: Locale }> }): Promise<Metadata> {
    ...
    return {
        ...
        description: t.cookies.title,
        alternates: {
            canonical: `https://devstudio.ru/${locale}/cookies`,
        },
    };
}
    ...
    return (
        <main className="min-h-screen bg-[#0a0f14] pt-32 pb-20 px-6 sm:px-10 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-white mb-12">{t.cookies.title}</h1>
                ...
                <div className="space-y-10 text-slate-300 leading-relaxed bg-[#1a1f26]/60 backdrop-blur-md border border-slate-700/50 p-8 sm:p-12 rounded-3xl shadow-xl">
                    {t.cookies.sections.map((section: { title: string; content: string }, idx: number) => (
                        <section key={idx}>
